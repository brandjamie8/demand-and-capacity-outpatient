...
if 'appointment_df' in st.session_state and st.session_state.appointment_df is not None:
    ...
    if all(column in appointment_df.columns for column in required_columns):
        ...
        specialty_appointment_df = appointment_df[appointment_df['specialty'] == selected_specialty]
        ...
        appointment_summary = specialty_appointment_df.groupby('appointment type').sum()['appointments completed'].reset_index()
